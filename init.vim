...
"        \ 'cmd': {server_info->['vls', '--stdio']},
"        \ 'whitelist': ['vue'],
"        \ })
"endif
"au FileType vue setlocal omnifunc=lsp#complete
"autocmd filetype vue nnoremap <silent> ;j :LspDefinition<CR>
"autocmd filetype vue nnoremap <silent> ;r :LspReferences<CR>
"autocmd filetype vue nnoremap <silent> ;i :LspHover<CR>
"autocmd filetype vue nnoremap <C-]> :LspDefinition<CR>
